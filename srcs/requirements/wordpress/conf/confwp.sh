...
if ! wp core is-installed --allow-root  ; then
	...
	wp config create --dbname=$SQL_DATABASE --dbuser=$SQL_USER --dbpass=$SQL_PASSWORD --dbhost=mariadb --path='/var/www/wordpress' --allow-root --force
	...
	wp user create $WORDPRESS_DB_USER ajeanne@student.42.fr --user_pass=$WORDPRESS_DB_PASSWORD --allow-root
